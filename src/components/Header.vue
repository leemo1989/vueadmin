                        ...
                        <div style="width: 500px;height: 300px;display: flex;justify-content: space-around">
                          <div>
                            ...
                            <p><el-link icon="el-icon-s-promotion">作业平台</el-link></p>
                              ...
                              <p><el-link icon="el-icon-s-promotion"><router-link to="/domain">域名管理</router-link></el-link></p>
                          </div>
                          <div>
                            <h3>监控系统</h3>
                            <el-divider></el-divider>
                            <p><el-link icon="el-icon-share"><router-link to="/cmdb">CMDB</router-link></el-link></p>
                          </div>
                          <div>
                            <h3>数据库</h3>
                            <el-divider></el-divider>
